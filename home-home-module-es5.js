...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
  ...
  function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! @angular/common/http */
    "./node_modules/@angular/common/fesm2015/http.js"); // home.page.ts


    var HomePage = /*#__PURE__*/function () {
      function HomePage(geolocation, nativeGeocoder, HttpClient) {
      ...
      _createClass(HomePage, [{
            ...
            _this.service.nearbySearch(request, function (results, status) {
              if (status === google.maps.places.PlacesServiceStatus.OK) {
                ...
                for (var i = 0; i < results.length; i++) {
                  ...
                  _this.getWether(results[i].geometry.location.lat(), results[i].geometry.location.lng()).subscribe(function (res) {
                    console.log('let datainfo =', res);
                    var data = JSON.stringify(res);
                    var content = "<h4>Current Weather!</h4>\n               <div>".concat(data, "</div>                \n              ");

                    _this.addMarker(_this.map, res.coord.lat, res.coord.lon, content);
                  });
                }
              }
            });
        ...
        key: "getWether",
        value: function getWether(lat, lon) {
          var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().set('x-rapidapi-host', 'community-open-weather-map.p.rapidapi.com').set('x-rapidapi-key', '0ff4de13e9mshbafda0022c0c6cfp18355ajsn2554e0eb87f4');
          return this.HttpClient.get("https://community-open-weather-map.p.rapidapi.com/weather?lat=".concat(lat, "&lon=").concat(lon), {
            headers: headers
          });
        }
      }, {
        key: "addMarker",
        value: function addMarker(map, lat, lng, content) {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_2__["Geolocation"], _ionic_native_native_geocoder_ngx__WEBPACK_IMPORTED_MODULE_3__["NativeGeocoder"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"]])], HomePage);
    /***/
  }
}]);
